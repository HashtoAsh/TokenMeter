...
- 字段含义见 [api-design.ZH.md](api-design.ZH.md)。
...
**Q5 费用对不上账号账单？** 统计口径只含 TokenMeter 自身的轮询请求，见 [README](../README.ZH.md) 的统计口径说明。
...
- [../README.ZH.md](../README.ZH.md)：总览、特性、配置
- [architecture.ZH.md](architecture.ZH.md)：架构、窗口状态机、存储
- [api-design.ZH.md](api-design.ZH.md)：命令、事件、config schema
- [tech-stack.ZH.md](tech-stack.ZH.md)：依赖与技术选型
