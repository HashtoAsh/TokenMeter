...
> 每轮记录"问题 → 根因 → 修法 → 验证"。窗口/贴边的实现细节见 [docs/architecture.ZH.md](docs/architecture.ZH.md) §5。
...
打包命令见 [docs/quick-start.ZH.md](docs/quick-start.ZH.md) §3；本机 cargo 缓存/镜像等环境细节见 `.local/local-build-notes.md`。
